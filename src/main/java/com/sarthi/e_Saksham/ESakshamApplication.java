...
//	@Bean
//	public ApplicationRunner init2(UserMstRepository userMstRepository) {
//		return args -> {
//			if (!userMstRepository.existsByUserNameIgnoreCase("e-Saksham-user")) {
//				UserMstEntity userMstEntity = DataUtility.getDefaultUserMstEntity();
//				userMstRepository.save(userMstEntity);
//			}
//		};
//	}
